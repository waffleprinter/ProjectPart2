...
public class MoneyDemo
{
    public static void main(String[] args)
    {
        ...
        // Determine if the third amount equals the first amount and store the result.
